  ...
  render() {
    ...
    return(
      <div className='seePOI'>
        ...
        <div className='map'> {this.state.mapData !== undefined ? <Map props={this.state.mapData} userLocation={{lat: this.state.lat, long: this.state.long}}></Map> : <div className='loading'> Loading...</div>}</div>
